...
User-facing documentation is located in the [`docs/`](docs/) directory and rendered in the [Project Wiki](https://github.com/tarantini-io/shelf/wiki).

- [Deployment Guide](docs/Deployment-Guide.md) — How to host Shelf yourself.
- [User Manual](docs/User-Manual.md) — How to use Shelf to manage your library.
- [Architecture & Principles](docs/Home.md#architecture) — Deep dive into the codebase design.
