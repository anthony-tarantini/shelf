...
Shelf now ships with two compose entry points:
...
Full documentation is available at **[tarantini-io.github.io/shelf](https://tarantini-io.github.io/shelf)**.

- [Quickstart](https://tarantini-io.github.io/shelf/getting-started/quickstart/) — Get Shelf running with Docker Compose.
- [Configuration](https://tarantini-io.github.io/shelf/getting-started/configuration/) — All environment variables in one place.
- [User Guide](https://tarantini-io.github.io/shelf/user-guide/importing-books/) — Import books, manage metadata, connect devices.
- [Architecture](https://tarantini-io.github.io/shelf/architecture/overview/) — Deep dive into the codebase design.
- [Contributing](https://tarantini-io.github.io/shelf/contributing/development-setup/) — Development setup and code conventions.

## 🗺️ Roadmap

Shelf is currently in **Active Development (Beta)**. Our upcoming goals include:

- [ ] Web-based Dashboard (UI) consolidation.
- [ ] OPDS 2.0 support.
...
`docker-compose.yaml` now supports the full local stack:
