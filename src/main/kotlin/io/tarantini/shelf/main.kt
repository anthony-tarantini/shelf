...
import io.tarantini.shelf.app.configureLogging
import io.tarantini.shelf.app.dependencies
...
fun main() = SuspendApp {
    val env = Env()
    configureLogging(env.observability)
    resourceScope {
...
fun Application.app(module: Dependencies) {
    ...
    routes(module)
    install(Cohort) {
        healthcheck("/readiness", module.healthCheck)
        healthcheck("/api/health", module.healthCheck)
    }
}
