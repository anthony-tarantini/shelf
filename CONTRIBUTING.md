...
-   Use the [Test Ownership Matrix](https://tarantini-io.github.io/shelf/contributing/testing/) to keep each decision rule tested in one primary layer and avoid duplicate assertions.
